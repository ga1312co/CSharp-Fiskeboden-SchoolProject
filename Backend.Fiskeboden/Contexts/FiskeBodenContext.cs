...
namespace Informatics.FiskebodenWebAPI.Contexts;

public partial class FiskeBodenContext : DbContext
{
    public FiskeBodenContext()
    {
    }

    public FiskeBodenContext(DbContextOptions<FiskeBodenContext> options)
        : base(options)
    {
    }
